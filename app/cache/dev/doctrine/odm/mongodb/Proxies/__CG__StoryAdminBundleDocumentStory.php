 ...
 */
class Story extends \Story\AdminBundle\Document\Story implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setStoryName($storyName);
    }

    public function getStoryName()
    {
        $this->__load();
        return parent::getStoryName();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'storyName', 'author', 'description');
    }
