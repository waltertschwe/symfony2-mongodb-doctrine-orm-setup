...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrineMongodb_Odm_DefaultConfigurationService()
    {
        ...
        $b = new \Doctrine\Bundle\MongoDBBundle\Mapping\Driver\YamlDriver(array('/var/www/Symfony/src/Story/AdminBundle/Resources/config/doctrine' => 'Story\\AdminBundle\\Document', '/var/www/Symfony/src/Story/SecurityBundle/Resources/config/doctrine' => 'Story\\SecurityBundle\\Document'));
        ...
        $instance->setDocumentNamespaces(array('StoryAdminBundle' => 'Story\\AdminBundle\\Document', 'StorySecurityBundle' => 'Story\\SecurityBundle\\Document'));
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Story\\SecurityBundle\\Document\\AdminUser' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha1', 1 => false, 2 => 1))));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.admin_area' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/test'))), $this->get('event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_AdminAreaService()
    {
        ...
        return $this->services['security.firewall.map.context.admin_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($f, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.in_memory')), 'admin_area', $a, $this->get('event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE)), 2 => new \Symfony\Component\Security\Http\Firewall\BasicAuthenticationListener($b, $c, 'admin_area', $g, $a), 3 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $f, $c, $a)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), new \Symfony\Component\Security\Http\HttpUtils($d, $d), 'admin_area', $g, NULL, NULL, $a));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('security.user.provider.concrete.in_memory'), new \Symfony\Component\Security\Core\User\UserChecker(), 'admin_area', $this->get('security.encoder_factory'), true)), true);
