...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'storyadmin_user_provider' => 'getStoryadminUserProviderService',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'StoryAdminBundle', '/var/www/Symfony/app/Resources/StoryAdminBundle/views', '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'StoryAdminBundle', '/var/www/Symfony/src/Story/AdminBundle/Resources/views', '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'symfony', 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => '%NN6prxt5', 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/var/www/Symfony/src/WebForms/TestBundle/Entity')), 'WebForms\\TestBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('WebFormsTestBundle' => 'WebForms\\TestBundle\\Entity'));
    ...
    protected function getDoctrineMongodb_Odm_DefaultConfigurationService()
    {
        ...
        $b = new \Doctrine\Bundle\MongoDBBundle\Mapping\Driver\YamlDriver(array('/var/www/Symfony/src/WebForms/TestBundle/Resources/config/doctrine' => 'WebForms\\TestBundle\\Document', '/var/www/Symfony/src/Story/AdminBundle/Resources/config/doctrine' => 'Story\\AdminBundle\\Document', '/var/www/Symfony/src/Story/SecurityBundle/Resources/config/doctrine' => 'Story\\SecurityBundle\\Document'));
        ...
        $c->addDriver($b, 'Story\\SecurityBundle\\Document');
        ...
        $instance->setDocumentNamespaces(array('WebFormsTestBundle' => 'WebForms\\TestBundle\\Document', 'StoryAdminBundle' => 'Story\\AdminBundle\\Document', 'StorySecurityBundle' => 'Story\\SecurityBundle\\Document'));
        ...
        $instance->setHydratorDir('/var/www/Symfony/app/cache/dev/doctrine/odm/mongodb/Hydrators');
        $instance->setHydratorNamespace('Hydrators');
        $instance->setAutoGenerateHydratorClasses(false);
        $instance->setDefaultDB('kickass');
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), '1075ba058c36107e2c6044d7e89369e24c');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return Story\SecurityBundle\Security\Firewall\WsseListener A Story\SecurityBundle\Security\Firewall\WsseListener instance.
     */
    protected function getSecurity_Authentication_Listener_Wsse_WsseSecuredService()
    {
        return $this->services['security.authentication.listener.wsse.wsse_secured'] = new \Story\SecurityBundle\Security\Firewall\WsseListener($this->get('security.context'), $this->get('security.authentication.manager'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return Story\SecurityBundle\Security\Authentication\Provider\WsseProvider A Story\SecurityBundle\Security\Authentication\Provider\WsseProvider instance.
     */
    protected function getSecurity_Authentication_Provider_Wsse_WsseSecuredService()
    {
        return $this->services['security.authentication.provider.wsse.wsse_secured'] = new \Story\SecurityBundle\Security\Authentication\Provider\WsseProvider($this->get('security.user.provider.concrete.in_memory'), '/var/www/Symfony/app/cache/dev/security/nonces');
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Story\\SecurityBundle\\Security\\User\\StoryAdminUser' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => false, 2 => 1))));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.wsse_secured' => new \Symfony\Component\HttpFoundation\RequestMatcher('/test/.*'), 'security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/demo/secured/login$'), 'security.firewall.map.context.secured_area' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/demo/secured/'))), $this->get('event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.in_memory')), 'secured_area', $b, $c), 2 => $f, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $this->get('security.authentication.manager'), new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $d, 'secured_area', $g, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $d, array('login_path' => '_demo_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $b), array('check_path' => '_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c), 4 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '_demo_login', false), NULL, NULL, $b));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_WsseSecuredService()
    {
        ...
        return $this->services['security.firewall.map.context.wsse_secured'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $a, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($a, '/'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/logout')), 2 => $this->get('security.authentication.listener.wsse.wsse_secured'), 3 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $a, 'wsse_secured', NULL, NULL, NULL, $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    /**
     * Gets the 'storyadmin_user_provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Story\SecurityBundle\Security\User\StoryAdminUserProvider A Story\SecurityBundle\Security\User\StoryAdminUserProvider instance.
     */
    protected function getStoryadminUserProviderService()
    {
        return $this->services['storyadmin_user_provider'] = new \Story\SecurityBundle\Security\User\StoryAdminUserProvider();
    }
    ...
    protected function getTemplating_Helper_LogoutUrlService()
    {
        ...
        $instance->registerListener('wsse_secured', '/logout', 'logout', '_csrf_token', NULL);
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'StoryAdminBundle'), $this->get('assetic.value_supplier.default', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('1075ba058c36107e2c6044d7e89369e24c');
    }
    ...
    {
        return $this->services['wsse.security.authentication.listener'] = new \Story\SecurityBundle\Security\Firewall\WsseListener($this->get('security.context'), $this->get('security.authentication.manager'));
    }
    ...
    {
        return $this->services['wsse.security.authentication.provider'] = new \Story\SecurityBundle\Security\Authentication\Provider\WsseProvider('', '/var/www/Symfony/app/cache/dev/security/nonces');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_user' => 'root',
            'database_password' => '%NN6prxt5',
            'mailer_transport' => 'smtp',
            'mailer_host' => 'localhost',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'locale' => 'en',
            'secret' => '1075ba058c36107e2c6044d7e89369e24c',
            ...
            'kernel.secret' => '1075ba058c36107e2c6044d7e89369e24c',
            ...
            'doctrine_mongodb.odm.proxy_dir' => '/var/www/Symfony/app/cache/dev/doctrine/odm/mongodb/Proxies',
            'doctrine_mongodb.odm.auto_generate_proxy_classes' => false,
            'doctrine_mongodb.odm.hydrator_namespace' => 'Hydrators',
            'doctrine_mongodb.odm.hydrator_dir' => '/var/www/Symfony/app/cache/dev/doctrine/odm/mongodb/Hydrators',
            ...
            'storyadmin_user_provider.class' => 'Story\\SecurityBundle\\Security\\User\\StoryAdminUserProvider',
